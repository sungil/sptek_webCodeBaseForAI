#!/usr/bin/env python3
"""Recreate Markdown files and move existing non-Markdown files from a tree-content export."""
...
DEFAULT_INPUT = Path.home() / "AI-tree-content.md"
DEFAULT_TARGET_PARENT = Path.home() / "tree-content-restore"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Import a tree-content export into directories and files.")
    parser.add_argument(
        "input",
        nargs="?",
        type=Path,
        default=DEFAULT_INPUT,
        help=f"Tree-content file to import. Default: {DEFAULT_INPUT}",
    )
    parser.add_argument(
        "-t",
        "--target-parent",
