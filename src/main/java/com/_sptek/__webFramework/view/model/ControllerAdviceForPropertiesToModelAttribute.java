...
@Slf4j
@Data
@Conditional(HasViewModelAttributePropertiesCondition.class)
@ControllerAdvice
...
public class ControllerAdviceForPropertiesToModelAttribute {
    private final ViewModelAttributeProperties viewModelAttributeProperties;
    ...
    public void addModelAttributes(Model model) {
        viewModelAttributeProperties.getAttributes()
