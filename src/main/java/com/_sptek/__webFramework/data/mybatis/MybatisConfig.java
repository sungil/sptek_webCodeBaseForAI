 ...
 *
 * <p>공통 MyBatis 설정 XML과 mapper XML은 cesco/__projectsCommon 하위에서 읽는다.
...
public class MybatisConfig implements WebMvcConfigurer {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setConfigLocation(this.applicationContext.getResources("classpath:/cesco/__projectsCommon/mybatis/*-config.xml")[0]);
        // Resource[] resources = this.applicationContext.getResources("classpath:/cesco/__projectsCommon/mybatis/*-config.xml");
        ...
        sqlSessionFactoryBean.setMapperLocations(this.applicationContext.getResources("classpath:/cesco/__projectsCommon/mybatis/**/*Mapper.xml"));
