...
public class AuthenticationViewController {
    ...
    public String curAuthentication(Model model) {
        Authentication curAuthentication = CurrentAuthenticationUtil.getMyAuthentication();
    ...
    @PreAuthorize("#email == null or #email == T(com._sptek.__webFramework.security.support.CurrentAuthenticationUtil).getMyEmail() or hasRole('ADMIN')")
    ...
    @PreAuthorize("#email == null or #email == T(com._sptek.__webFramework.security.support.CurrentAuthenticationUtil).getMyEmail() or hasAuthority(T(com._sptek._webFrameworkExample.unit.authentication.authorization.DomainAuthorityEnum).AUTH_SPECIAL_FOR_TEST.name())")
    ...
    @PreAuthorize("#userUpdateRequestDto.email == T(com._sptek.__webFramework.security.support.CurrentAuthenticationUtil).getMyEmail() or hasAuthority(T(com._sptek._webFrameworkExample.unit.authentication.authorization.DomainAuthorityEnum).AUTH_SPECIAL_FOR_TEST.name())")
