package com.sptek.__webFramework.example.unit.authentication;

import com.sptek.__webFramework.view.error.Enable_ResponseOfViewGlobalException_At_ViewController;
import com.sptek.__webFramework.security.userStore.dto.*;
...
public class AuthenticationViewController {
    ...
    @PreAuthorize("#email == null or #email == T(com.sptek.__webFramework.security.util.AuthenticationUtil).getMyEmail() or hasRole('ADMIN')")
    ...
    @PreAuthorize("#email == null or #email == T(com.sptek.__webFramework.security.util.AuthenticationUtil).getMyEmail() or hasAuthority(T(com.sptek.__webFramework.security.authorization.AuthorityEnum).AUTH_SPECIAL_FOR_TEST)")
    ...
    @PreAuthorize("#userUpdateRequestDto.email == T(com.sptek.__webFramework.security.util.AuthenticationUtil).getMyEmail() or hasAuthority(T(com.sptek.__webFramework.security.authorization.AuthorityEnum).AUTH_SPECIAL_FOR_TEST)")
