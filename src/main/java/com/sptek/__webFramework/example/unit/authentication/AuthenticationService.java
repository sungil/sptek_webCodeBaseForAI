...
import com.sptek.__webFramework.security.userStore.entity.*;
import com.sptek.__webFramework.security.userStore.repository.AuthorityRepository;
...
//                .collect(Collectors.toList());
     ...
     */
    @PreAuthorize("hasAuthority(T(com.sptek.__webFramework.security.authorization.AuthorityEnum).AUTH_SPECIAL_FOR_TEST)")
