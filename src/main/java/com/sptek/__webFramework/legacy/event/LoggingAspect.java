package com.sptek.__webFramework.legacy.event;
...
//    //@Before("execution(* com.sptek..*(..)) && !execution(* com.sptek.__webFramework.web.filter..*(..))")
...
//
//    @After("execution(* com.sptek..*(..)) && !execution(* com.sptek.__webFramework.web.filter..*(..)) && !execution(* com.sptek._projectCommon.filter..*(..))")
//    public Object trackMethodUsage(ProceedingJoinPoint joinPoint) throws Throwable {
//        MethodSignature signature = (MethodSignature) joinPoint.getSignature();
//        String methodName = signature.getDeclaringTypeName() + "." + signature.getName();
//
...
//    }
     ...
     */
    @After("execution(* com.sptek..*(..)) && !within(com.sptek.__webFramework.web.filter..*) && !within(com.sptek._projectCommon.filter..*)")
